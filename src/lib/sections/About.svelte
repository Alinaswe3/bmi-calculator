...
<section
        class="relative grid grid-cols-2 gap-[13rem] tablet:gap-[9rem] tablet:grid-cols-1 items-end justify-items-center">

    <img alt="A man eating food" class="tablet:max-w-full tablet:max-h-[65rem] max-w-[56.4rem] max-h-[53.3rem]"
         src="/images/image-man-eating.webp"/>

    <div class="tablet:max-w-full max-w-[47rem] justify-self-end -translate-y-[12%]">
        <h2 class="heading text-h-lg tracking-[-2.4px] mb-[3.5rem]">What your BMI result means</h2>
        <p class="text-b-md leading-body">
